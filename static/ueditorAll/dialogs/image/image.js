 ...
 */
var imageUploader = {};
var selLocal = document.getElementById("selLocal");
var selManager = document.getElementById("selManager");
(function () {
    var g = $G,
    ...
    imageUploader.init = function (opt, callbacks) {
        ...
        //opt.url = editor.options.imageUrl;
        createFlash(opt, callbacks);
        //document.getElementById("selLocal").onchange = function () {
        //    opt.url = editor.options.imageUrl + "?albumId=" + $("#selLocal").val() + "&type=blog";
        //    createFlash(opt, callbacks);
        //};
        document.getElementById("selManager").onchange = function () {
            getAlbumImages();
        };
    ...
    function showImageInfo(img) {
        ...
        if (img.width && img.height) {
            ...
            img.width = img.width > 650 ? 650 : img.width;
    ...
    */
    function getAlbumImages() {
        var requestData = "album_id=" + $("#selManager").val();
        function showImages(obj) {
            if (obj.type) {
                g("imageList").innerHTML = !obj.data.length ? "&nbsp;&nbsp;" + lang.noUploadImage : "";
                //去除空格
                for (var k = 0; k < obj.data.length; k++) {
                    ...
                    img.setAttribute(k < 35 ? "src" : "lazy_src", changeImageSize(obj.data[k].photo_path, 64));
                    img.setAttribute("data_ue_src", obj.data[k].photo_path);

                }
            }
        }
        AjaxForJson(editor.options.getImages, requestData, showImages, null, null);
    }
    ...
    function switchTab(tabParentId) {
        var tabElements = g(tabParentId).children,
                tabHeads = tabElements[0].children,
                tabBodys = tabElements[1].children;
        clickHandler.onmouseover = function () {
            $(this).addClass("hover");
        }
        clickHandler.onmouseout = function () {
