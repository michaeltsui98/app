    ...
    fileView: function (containerId) {
        ...
        if (perview_type == "isTxt") {
            ...
            new syPPT({
                ...
                botton_hidden: 0,
                skin: commonParams.jcDevPath + '/static/fpaper/skin/comp'
            }).show();
            $('#' + containerId).css("border", "1px solid #96b9cf");
            $.ajaxJSONP(commonParams.wenkuPath + "/info/views/id/" + id, null, function () { });
        }
        else if (perview_type == "isDown") {
            ...
            var flashvars = {
                f: 'http://dev-images.dodoedu.com/resource/' + file_key,
            ...
            swfobject.embedSWF(commonParams.jcDevPath + '/static/ckplayer/ckplayer.swf', containerId, document.getElementById(containerId).offsetWidth, document.getElementById(containerId).offsetHeight, '10.0.0', commonParams.jcDevPath + '/static/ckplayer/expressInstall.swf', flashvars, params, attributes);
