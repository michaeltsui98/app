...
UE.I18N['zh-cn'] = {
    'labelMap':{
        'anchor':'锚点', 'undo':'撤销', 'redo':'重做', 'bold':'加粗', 'indent':'首行缩进', 'snapscreen':'截图','morefunction':'更多功能',
        ...
        'edittable':'表格属性','edittd':'单元格属性', 'link':'超链接','emotion':'表情', 'spechars':'特殊字符', 'searchreplace':'查询替换', 'map':'Baidu地图', 'gmap':'Google地图','thumbnail':'文章缩略图',
    ...
    'music': {
        'static': {
            lang_tab_insertV: "搜索音乐",
            lang_tab_searchV: "网盘音乐",
    ...
    'insertvideo':{
        'static':{
            lang_tab_insertV:"网上视频",
            lang_tab_searchV: "网盘视频",
            lang_tab_uploadV:"本地上传",
            lang_video_url:"视频网址",
            lang_video_size:"视频尺寸",
            lang_videoW:"宽度",
