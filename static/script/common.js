...
btnLoading.prototype.toLoading = function (ifCover) {
    $(this.main).replaceWith('<img id="btnLoading" class="loadingStyle"  src="' + commonParams.wenkuPath + '/static/public/images/login/loading.gif" alt="">');
    if (ifCover) {
