...
class Cola_Controller
{
     ...
     * @param string $tpl
     */
    protected function display($tpl = null, $dir = null,$isReturn=false)
    {
        return $this->tpl($tpl,$dir,$isReturn);
    }
    /**
     * 加载模板
     */
    ...
    public  function renderJsonpData($data){
