...
class Cola_Com_Pager
{
    ...
    protected $_config = array(
        ...
        'showSinglePage' => false,
            //<style type="text/css">.pages{float:right;font-size:12px;} .pages *{border:1px solid #E6E7E1;height:24px;line-height:24px;padding:3px 6px;margin:1px;color:#0099CC;} .pages b{background-color:#0099CC;border-color:#0099CC;color:#FFFFFF;} .pages a {text-decoration:none;} .pages a:hover{border-color:#0099CC;} .pn{border-color:#0099CC;}</style>
        ...
        'current' => '<b class="current">%page%</b>',
