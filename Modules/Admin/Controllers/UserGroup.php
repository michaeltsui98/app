...
class Modules_Admin_Controllers_UserGroup extends  Modules_Admin_Controllers_Base {
	...
	public function jsonAction() {
	    ...
	    $group =  Modules_Admin_Models_SysGroup::init()->getGroupList($page, $rows);
	    $this->view->group = $group;
	...
	public function purviewAction() {
	    ...
	    //取模板列表
	    $module =  Modules_Admin_Models_SysModule::init()->getTreeList( $page,300,1, "module_order ASC", 'cat');
